...
func SetDefaultKeybinds(player: int = 0):
	...
	if player != 1:
		InputMap.action_erase_events("P2_MV_L")
		InputMap.action_add_event("P2_MV_L", Default_P2_MV_L)
		InputMap.action_erase_events("P2_MV_R")
		InputMap.action_add_event("P2_MV_R", Default_P2_MV_R)
		InputMap.action_erase_events("P2_SD")
		InputMap.action_add_event("P2_SD", Default_P2_SD)
		InputMap.action_erase_events("P2_HD")
		InputMap.action_add_event("P2_HD", Default_P2_HD)
		InputMap.action_erase_events("P2_CW")
		InputMap.action_add_event("P2_CW", Default_P2_CW)
		InputMap.action_erase_events("P2_CCW")
		InputMap.action_add_event("P2_CCW", Default_P2_CCW)
		InputMap.action_erase_events("P2_180")
		InputMap.action_add_event("P2_180", Default_P2_180)
		InputMap.action_erase_events("P2_HOLD")
